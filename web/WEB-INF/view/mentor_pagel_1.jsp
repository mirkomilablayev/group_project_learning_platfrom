            ...
            <div class="container-fluid" style="background-color: blueviolet;">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        <a class="nav-link active" aria-current="page" href="/addCourse/${currentUser.id}">
                    ...
                    <c:forEach var="c" items="${courses}">
                        <div class="card;" class="col-10 offset-1"
                            ...
                            <div class="card-body">
                                ...
                                <c:choose>
                                    <c:when test="${c.course.isCanceled eq true}">
                                        <p>Canceled !!!</p></c:when>
                                ...
                                <c:choose>
                                    <c:when test="${c.course.isCanceled eq true}">
                                        <a href="/deleteCourse/${c.course.id}/${currentUser.id}"
